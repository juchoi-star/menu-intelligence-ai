...
import { PCUploadPanel } from "@/components/pc/PCUploadPanel";
        ...
        {!hydrated ? null : !result ? (
          ...
          <>
            <div className="grid grid-cols-2 gap-4 lg:grid-cols-5">
              ...
              <StatCard
                label="판매 상품수"
                value={num(result.dashboard.product_count_curr)}
            ...
            <Card className="shadow-glow">
              <CardBody>
                <SectionHeader
                  ...
                  right={
                    <Link href="/pc/report" className="text-sm font-medium text-gold hover:underline">
                      전체 리포트 →
                    </Link>
                  }
                />
